...
proc create_root_design { parentCell } {
  ...
  # Create instance: ReverseEndiannessCop_0, and set properties
  set ReverseEndiannessCop_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ReverseEndiannessCop:1.0 ReverseEndiannessCop_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ReverseEndiannessCop_0_M00_AXIS [get_bd_intf_pins ReverseEndiannessCop_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins ReverseEndiannessCop_0/S00_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  exclude_bd_addr_seg -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_gpio_buttons/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_gpio_displays/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_gpio_leds/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_gpio_switches/S_AXI/Reg]
