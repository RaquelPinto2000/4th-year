...
HD_PWD='C:/Academico/UA/4ano/2semestre/CR/Pratica/Guiao2/guiao2/guiao2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_1Hz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_1Hz.tcl -notrace
