...
HD_PWD='C:/Academico/UA/4ano/2semestre/CR/Pratica/Guiao2/guiao2/guiao2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_1Hz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_1Hz.tcl
