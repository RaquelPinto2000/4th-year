...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../countdownTimer.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../countdownTimer.gen/sources_1/bd/mb_design/ipshared/d0f7" \
       +incdir+"../../../../countdownTimer.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../countdownTimer.gen/sources_1/bd/mb_design/ipshared/d0f7"
}
