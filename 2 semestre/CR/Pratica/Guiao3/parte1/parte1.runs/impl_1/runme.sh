...
HD_PWD='C:/Academico/UA/4ano/2semestre/CR/Pratica/Guiao3/parte1/parte1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_driver.tcl -notrace
