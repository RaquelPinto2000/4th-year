...
HD_PWD='C:/Academico/UA/4ano/2semestre/CR/Pratica/Guiao3/parte1/parte1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_driver.tcl
