...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PopCount_0_M00_AXIS [get_bd_intf_pins PopCount_0/M00_AXIS] [get_bd_intf_pins microblaze_0/S1_AXIS]
  connect_bd_intf_net -intf_net ReverseEndiannessCop_0_M00_AXIS [get_bd_intf_pins ReverseEndiannessCop_0/M00_AXIS] [get_bd_intf_pins microblaze_0/S0_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M0_AXIS [get_bd_intf_pins ReverseEndiannessCop_0/S00_AXIS] [get_bd_intf_pins microblaze_0/M0_AXIS]
  connect_bd_intf_net -intf_net microblaze_0_M1_AXIS [get_bd_intf_pins PopCount_0/S00_AXIS] [get_bd_intf_pins microblaze_0/M1_AXIS]
