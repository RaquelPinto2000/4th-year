...
public class jClient {
  ...
  double initialX, initialY;  // Initial X and Y GPS coords
  ...
  */
  public void mainLoop () {
    ...
    // Read X and Y coords of starting position
    cif.ReadSensors();
    initialX = cif.GetX();
    initialY = cif.GetY();
  ...
  /**
  * Main actions of the robot
  */
  public void act() {
    cif.DriveMotors(0.03,0.03);
    System.out.print(cif.GetX() - initialX);
    System.out.print("\t");
    System.out.println(cif.GetY() - initialY);
